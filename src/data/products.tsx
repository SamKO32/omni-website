export const products = [
  ...
  //   hoverImage: '/images/NASA HOODIE BACK.png', 
  //   extraImages: ['/images/NASA HOODIE BACK.png'],
  //   description: 'Interstellar piece. Premium fleece-lined.',
  //   sizes: ["S", "M", "L", "XL"]
  // },
  
  {
    ...
    description: 'OMNI PSP Tee. Super soft and lightweight. Made from 100% cotton.',
    sizes: ["S", "M", "L", "XL"]
  },
  {
    id: 2,
    ...
    description: 'No honey pack needed. Made from 100% cotton.',
    sizes: ["S", "M", "L", "XL"]
  },
  {
    id: 3,
    ...
    description: 'Member hoodie, exclusive cut.',
    sizes: ["S", "M", "L", "XL"]
  }
  // {
  //   id: 5,
